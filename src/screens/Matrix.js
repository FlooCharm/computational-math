			...
			<div className='app'>
				...
				<div className='row'>
					...
					<div className='flex1'>
						<h1>Code</h1>
						<h6>Complete code on
							<a href='https://github.com/FlooCharm/computational-math/blob/master/src/screens/Matrix.js' target="_blank" rel="noopener noreferrer"> https://github.com/FlooCharm/computational-math</a>
						</h6>
